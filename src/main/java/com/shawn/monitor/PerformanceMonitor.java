...
public class PerformanceMonitor {
    ...
    /**
     * A join point is in the controller layer if the method is modified by public and defined in a type in the
     * com.shawn.service package or any sub-package under that and modified by public.
     */
    @Pointcut("execution(public * com.shawn.web.controller..*(..))")
    private void controllerLayer() {}

    /**
     * Monitor the elapsed time of method on controller layer, in order to detect performance problems as soon as
     * possible. If elapsed time > 1 s, log it as an error. Otherwise, log it as an info.
     */
