...
public class ServiceMonitor {
    ...
    /**
     * A join point is in the service layer if the method is defined in a type in the com.shawn.service package or any
    ...
    /**
     * Monitor whether exception is thrown in service layer. If exception has been thrown, in order to detecting it
     * conveniently, log the situation where it happened. Then create a server internal error exception and throw it
     * out.
     */
