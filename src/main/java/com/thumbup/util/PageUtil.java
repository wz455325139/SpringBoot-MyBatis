package com.thumbup.util;

import com.thumbup.web.exception.ParameterIllegalException;
...
public class PageUtil {
     ...
     *            size of per page
     * @param defaultValue
     *            default return value, if page < 1
     * @return offset
     */
     ...
     *            origin
     * @param defaultValue
     *            default page, if pageString == null
     * @return parsed page
     */
     ...
     *            origin
     * @param defaultValue
     *            default size of per page, if perPageString == null
    ...
    /**
     * A helper method, parsing parameter about pagination. If the string is null, return the default value. If the
     * string is not a number or the number < 1, throw a parameter illegal exception.
     *
     * @param parameterString
     *            origin
     * @param defaultValue
     *            default value, if parameterString == null
